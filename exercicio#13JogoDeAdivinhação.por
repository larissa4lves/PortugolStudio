programa
{
	...
	funcao inicio()
	{
		escreva("Pensar em um numero de 1 até 8 \n")
		...
		se (resposta == 's'){ // 1 até 4
			...
			se (resposta == 's'){ // 3 ou 4
				...
				leia (resposta)
				se (resposta == 's'){
					escreva("Você pensou no numero 4! \n")
			}
			senao {
			...
			senao {// 1 ou 2
				...
				se (resposta == 's'){
					escreva (" VocêPensou no número 2! \n")
				}
			
				senao {
					escreva (" VocêPensou no número 1! \n")
			}
		}
	...
	senao {//5 a 8
		escreva ("O número é maior que 6? \n")
			...
			se (resposta == 's'){// 7 ou 8
				...
				leia (resposta)
				se (resposta == 's'){
					escreva("Você pensou no numero 8! \n")
			}
			senao{
